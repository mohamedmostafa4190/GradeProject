...
class DeleteDiagnoses extends StatefulWidget {
  const DeleteDiagnoses({Key? key}) : super(key: key);

  @override
  State<DeleteDiagnoses> createState() => _DeleteAdminState();
}

class _DeleteAdminState extends State<DeleteDiagnoses> {
                    ...
                    children: [
                      ...
                      Center(
                        child: ConditionalBuilder(
                          condition: state is! AppDeleteDiagnosesLoadingStates,
                          builder: (context) => defultButton(
                              ...
                              onPressed: () {
                                ...
                                if (formKey.currentState!.validate()) {
                                  cubit.deleteDiagnoses(
                                    deleteID: diagnosesValue.toString(),
                                  );
                                }
                              }),
